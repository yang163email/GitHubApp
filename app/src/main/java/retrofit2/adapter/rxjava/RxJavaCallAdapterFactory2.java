...
public final class RxJavaCallAdapterFactory2 extends CallAdapter.Factory {
    ...
    public static RxJavaCallAdapterFactory2 createWithSchedulers(@Nonnull Scheduler schedulerSubscribeOn, @Nonnull Scheduler schedulerObserverOn) {
        if (schedulerSubscribeOn == null)
            throw new NullPointerException("schedulerSubscribeOn == null");
        if (schedulerObserverOn == null)
            throw new NullPointerException("schedulerObserverOn == null");
        return new RxJavaCallAdapterFactory2(schedulerSubscribeOn, schedulerObserverOn, false);
    }
    ...
    private RxJavaCallAdapterFactory2(@Nullable Scheduler schedulerSubscribeOn,
                                      @Nullable Scheduler schedulerObserverOn, boolean isAsync) {
    ...
    public CallAdapter<?, ?> get(Type returnType, Annotation[] annotations, Retrofit retrofit) {
        ...
        if (isCompletable) {
            return new RxJavaCallAdapter2(Void.class, schedulerSubscribeOn, schedulerObserverOn, isAsync, false, true, false, true);
        }
        ...
        return new RxJavaCallAdapter2(responseType, schedulerSubscribeOn, schedulerObserverOn, isAsync, isResult, isBody, isSingle,
                false);
    }
}
